...
#define KIM1_MONITOR_BASE 0x1800
#define KIM1_MONITOR_END  0x1FFF
#define KIM1_MONITOR_SIZE (KIM1_MONITOR_END - KIM1_MONITOR_BASE + 1)

const uint8_t KIM1_MONITOR_ROM[] PROGMEM = {
